						...
						<div className="row p-2 bg-white shadow-lg p-3 mb-5 bg-body rounded">
							...
							<div className="col p-2">
								<div className="bd-placeholder-img card-img-top mb-2">
									<img id="overlay-post-view" className="img-fluid mx-auto d-block user-img" src="#" alt="user post"/>
								</div>
							...
							<div className="col-md-4 d-flex flex-column justify-content-between" >
								...
								<div className="row p-3">
									<div className="col-md-10">
										<input id="comment-input-big-view" type="text" className="inpt-comment form-control"
											placeholder="Add your comment" aria-label="Add your comment" />
									</div>

									<div className="col-md-2 d-flex justify-content-start">
										<button id="post-comment-btn-big-view" className="btn btn-outline-secondary" >Post</button>
									</div>
