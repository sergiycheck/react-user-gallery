...
import { StatusData, postsRoute, commentsRoute } from "../../api/ApiRoutes";
...
export const fetchPostComments = createAsyncThunk("comments/fetchCommentsForPost", async ({ postId, from, to }) => {
...
export const addNewComment = createAsyncThunk("comments/addNewComment", async ({ postId, text }, { getState }) => {
